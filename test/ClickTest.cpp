 ...
 * The pin intLed (StatusPin) is used for output attach a led and resistor to ground
...
void loop() {
  ...
  if(timer1.running() == true) digitalWrite(led1, HIGH);
